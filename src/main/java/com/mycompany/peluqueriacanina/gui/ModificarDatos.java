...
public class ModificarDatos extends javax.swing.JFrame {
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(txtNomDuenio, javax.swing.GroupLayout.PREFERRED_SIZE, 173, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("/home/omar/Descargas/icono.png")); // NOI18N
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        //los datos del dueño
        String nombrePropie = txtNomDuenio.getText();
        String celPropie = txtCelDuenio.getText();
        
        control.modificarMascota(masco,nombreMasco,raza,color,observaciones,alergico,atencionEspe,nombrePropie,celPropie);
        
        //mensaje de que todo salio ok
        mostrarMensaje("Edicion realizada correctamente", "Info", "Edicición correcta");
    ...
    private void cargarDatos(int num_cliente) {
        this.masco = control.traerMascota(num_cliente);
         txtNombre.setText(masco.getNombre());
            ...
            txtNomDuenio.setText(masco.getProp().getPropieNombre());
            txtCelDuenio.setText(masco.getProp().getCelPropie());
            txtaObservaciones.setText(masco.getObservaciones());
